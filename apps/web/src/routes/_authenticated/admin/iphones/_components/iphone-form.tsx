...
import { baseIphoneSchema } from "@web/routes/_authenticated/admin/iphones/_apis/iphone-schema.ts"
import { useUploadProductImage } from "@web/routes/_authenticated/admin/iphones/_hooks/use-upload-product-image.ts"
