...
import { makeGetIphone } from "@/application/iphone/get-iphone.ts"
import { makeListIphones } from "@/application/iphone/list-iphones.ts"
import { makeUpdateIphone } from "@/application/iphone/update-iphone.ts"
import { makeCancelOrder } from "@/application/order/cancel-order.ts"
import { makeCompleteOrder } from "@/application/order/complete-order.ts"
import { makeConfirmOrder } from "@/application/order/confirm-order.ts"
import { makeGetOrder } from "@/application/order/get-order.ts"
import { makeListAllOrders } from "@/application/order/list-all-orders.ts"
import { makeListMyOrders } from "@/application/order/list-my-orders.ts"
import { makePlaceOrder } from "@/application/order/place-order.ts"
import { makeRejectOrder } from "@/application/order/reject-order.ts"
